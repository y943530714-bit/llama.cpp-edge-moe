...
MODEL = "C:/workspace/models/Qwen3.6-35B-A3B-UD-Q4_K_M.gguf"
PORT = 8899
...
def main():
    ...
    server_cmd = [
        ...
        "-md", "C:/workspace/models/Qwen3.6-35B-A3B-DFlash-Q4_K_M.gguf", "--spec-type", "draft-dflash", "--spec-draft-n-max", "7", "--spec-relaxed-verify",
    ]
    log = open("edge-moe-results/server_c_spec.log", "wb")
    ...
    with open("edge-moe-results/server_spec_c_hit_rate.json", "w") as f:
