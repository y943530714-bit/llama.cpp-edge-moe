...
def main():
    ...
    server_cmd = [
        ...
        "-md", "D:\workspace\models\Qwen3.6-35B-A3B-DFlash-Q4_K_M.gguf", "--spec-type", "draft-dflash", "--spec-draft-n-max", "7", "--spec-relaxed-verify",
    ]
    ...
    with open("edge-moe-results/server_spec_hit_rate.json", "w") as f:
